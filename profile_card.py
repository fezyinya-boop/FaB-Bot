...
def draw_tracked_name(base_img, text_value, pos, font, tracking, fill=(236, 236, 240, 255),
    ...
    for i, ch in enumerate(chars):
        ...
        d.text((cx, y + 1), ch, font=font, fill=(120, 80, 28, 215), stroke_width=max(1, stroke_width), stroke_fill=(0, 0, 0, 180))
        d.text((cx, y), ch, font=font, fill=(242, 196, 98, 255), stroke_width=max(1, stroke_width), stroke_fill=(8, 8, 12, 210))
        d.text((cx, y - 2), ch, font=font, fill=(255, 244, 210, 80))
...
def add_carbon_fiber_texture(base: Image.Image, panel_y: int, panel_y2: int, scale_fn) -> Image.Image:
    ...
    for y in range(panel_y + scale_fn(10), panel_y2 - scale_fn(12), row_h):
        ...
        for x in range((-cell // 2) if odd else 0, W + cell, cell):
            ...
            x2 = x + cell
            cy = y + row_h // 2
            td.polygon([(x1, y), (x2, cy), (x1, y + row_h), (x0, cy)], outline=(255, 255, 255, 10))
