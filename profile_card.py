...
def make_profile_card(
    ...
    pd.rounded_rectangle(
        (S(28), panel_y + S(18), panel_x1 - S(24), panel_y2),
        radius=S(28),
        fill=(12, 12, 16, 214),
        outline=PANEL_LINE,
        width=S(2),
    ...
    if badge:
        badge_y = identity_y + (name_bbox[3] - name_bbox[1]) // 2 - badge.size[1] // 2 + S(1)
        badge_x = min(name_bbox[2] + S(12), left_rail_x2 - badge.size[0] - S(12))
