...
def make_profile_card(
    ...
    f_move = fit_font(draw, move_text, "Inter-VariableFont_opsz,wght.ttf", sig_w - S(32), S(20), S(13))
    move_text = clamp_text(draw, move_text, f_move, sig_w - S(32))
    draw.text((sig_x + S(16), sig_y + S(42)), move_text, font=f_move, fill=WHITE if p_move else SUB, stroke_width=S(2), stroke_fill=(0, 0, 0, 165))
