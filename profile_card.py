...
def make_profile_card(
    ...
    f_move = fit_font(draw, move_text, "Inter-VariableFont_opsz,wght.ttf", text_max_w, S(20), S(14))
    move_lines = wrap_text(draw, move_text, f_move, text_max_w, max_lines=7)
    line_h = max(S(18), (getattr(f_move, "size", S(15)) + S(4)))
    text_y = sig_y + S(36)
    ...
    stat_block(right_x, row1_y, "RECORD", f"{wins}W – {losses}L", value_font=f_value)
