...
def make_profile_card(
    ...
    draw.text((title_x, header2_y + S(26)), "Archive Arena • Season 1", font=f_brand, fill=GOLD, stroke_width=S(2), stroke_fill=(0, 0, 0, 165))
    ...
    content_top = panel_y + S(8)
    left_x = col_left
    right_x = col_left + int((col_right - col_left) * 0.70)
    row1_y = content_top + S(24)
    row2_y = content_top + S(118)
