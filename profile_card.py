...
def make_profile_card(
    ...
    streak_label_y = name_y + S(140)
    streak_value_y = streak_label_y + S(42)
    rating_label_y = streak_label_y  # aligned opposite streak
    rating_value_y = rating_label_y + S(34)

    # Divider between name row and rating row
    divider_y = record_value_y + S(36)
    ...
    text_h = max(S(90), f_big.size + S(24))
    for i in range(text_h):
        t = i / max(1, text_h - 1)
