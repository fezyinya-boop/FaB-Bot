...
def make_profile_card(
    ...
    f_move = fit_font(draw, move_text, "Inter-VariableFont_opsz,wght.ttf", text_max_w, S(17), S(11))
    move_lines = wrap_text(draw, move_text, f_move, text_max_w, max_lines=4)
    line_h = max(S(16), (getattr(f_move, "size", S(13)) + S(3)))
    text_y = sig_y + S(40)
    ...
    stat_block(right_x, row2_y + S(10), "STREAK", streak_text, value_font=f_value, value_fill=streak_fill)
