...
def draw_tracked_name(base_img, text_value, pos, font, tracking, fill=(236, 236, 240, 255),
                      ...
                      glow_fill=(255, 220, 170, 46), underline_fill=(255, 200, 90, 82),
    ...
    for i, ch in enumerate(chars):
        ...
        # tiny top highlight to fake metallic sheen
        d.text((cx, y - 1), ch, font=font, fill=(255, 255, 255, 40))
        cx += widths[i] + (tracking if i < len(chars) - 1 else 0)
...
# Square off the top by extending full width - removes rounded top corners
    ...
    f_name = fit_font(draw, name_text, "RussoOne-Regular.ttf", max_w=S(500), start_size=S(48), min_size=S(22))
